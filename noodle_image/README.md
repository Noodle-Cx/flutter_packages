...
## Why use NoodleImage
In a big project you probably uses some different types of images, like png or svg from network or local, but in code all this images are Strings types.
NoodleImage knows identify and provide correct widget to each image type avoiding errors and crashes.
